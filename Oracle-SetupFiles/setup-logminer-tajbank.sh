...
sqlplus sys/top_secret@//localhost:1521/ORCLCDB as sysdba <<- EOF
  ...
  GRANT SELECT ON V_$LOGMNR_LOGS TO c##tajuser CONTAINER=ALL;
  GRANT SELECT ON V_$LOGMNR_CONTENTS TO c##tajuser CONTAINER=ALL;
  GRANT SELECT ON V_$LOGFILE TO c##tajuser CONTAINER=ALL;
  GRANT SELECT ON V_$ARCHIVED_LOG TO c##tajuser CONTAINER=ALL;
  GRANT SELECT ON V_$ARCHIVE_DEST_STATUS TO c##tajuser CONTAINER=ALL;
